package com.example.a4applogin;
...
import com.example.a4applogin.bean.UserInfo;
import com.example.a4applogin.database.UserDBHelper;
import com.example.a4applogin.util.DateUtil;
import com.example.a4applogin.util.ViewUtil;

public class MainActivity extends AppCompatActivity implements OnCheckedChangeListener,View.OnClickListener, View.OnFocusChangeListener {
    ...
    private Button btn_register; // 声明一个注册按钮控件对象
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990039 缪王玺"};
